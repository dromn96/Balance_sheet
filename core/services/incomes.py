...
from core.models import Income, CategoryIncome


def get_incomes_by_category(profile, year=2025):

    expenses_by_category = Income.objects.filter(date_created__year=year, profile=profile) \
